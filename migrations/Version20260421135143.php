 ...
 */
final class Version20260421135143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dentist (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, specialty VARCHAR(100) NOT NULL, available_days VARCHAR(100) NOT NULL, phone VARCHAR(20) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE patient (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, national_id INT NOT NULL, age INT DEFAULT NULL, social_security_number VARCHAR(20) NOT NULL, phone VARCHAR(20) NOT NULL, email VARCHAR(100) NOT NULL, address VARCHAR(255) NOT NULL, billing_data VARCHAR(500) NOT NULL, health_status VARCHAR(500) NOT NULL, family_history VARCHAR(500) NOT NULL, lifestyle_habits VARCHAR(500) NOT NULL, medication_allergies VARCHAR(500) NOT NULL, registration_date DATETIME NOT NULL, password VARCHAR(255) DEFAULT NULL, odontogram JSON DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE treatment (id INT AUTO_INCREMENT NOT NULL, treatment_name VARCHAR(150) NOT NULL, description LONGTEXT DEFAULT NULL, category VARCHAR(100) NOT NULL, duration INT NOT NULL, price NUMERIC(10, 2) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE appointment ADD CONSTRAINT FK_FE38F844471C0366 FOREIGN KEY (treatment_id) REFERENCES treatment (id) ON DELETE CASCADE');
